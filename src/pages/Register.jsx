      ...
      <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-slate-50 to-blue-100 px-4 py-12">
        <div className="w-full max-w-lg bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-white">
          <div className="mb-8 text-center">
            ...
            <p className="mt-2 text-sm text-slate-500 font-medium">Join the Campus Share community</p>
          </div>
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="block text-xs font-semibold uppercase tracking-wider text-slate-500 ml-1 mb-1">First Name</label>
                <input
                  name="first_name"
                  required
              ...
              <div>
                <label className="block text-xs font-semibold uppercase tracking-wider text-slate-500 ml-1 mb-1">Last Name</label>
                <input
                  name="last_name"
                  required
                  onChange={handleChange}
            ...
            <div>
              <label className="block text-xs font-semibold uppercase tracking-wider text-slate-500 ml-1 mb-1">Student Email</label>
              <input
                name="email"
                type="email"
                required
            ...
            <div>
              <label className="block text-xs font-semibold uppercase tracking-wider text-slate-500 ml-1 mb-1">Student ID (Optional)</label>
              <input
                name="student_id"
                onChange={handleChange}
                className="block w-full rounded-xl border-slate-200 bg-slate-50/50 px-4 py-2.5 text-sm transition-all focus:border-indigo-500 focus:bg-white focus:ring-4 focus:ring-indigo-500/10 outline-none"
